...
public class WiFiWhiteListDialog extends DialogFragment {
	...
	public WiFiWhiteListDialog(SharedPreferences sharedPreferences) {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String[] whiteArray = sharedPreferences.getString("enableWiFiWhiteList", "").split(";");
