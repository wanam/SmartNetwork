...
public class MobileWhiteListDialog extends DialogFragment {
	...
	public MobileWhiteListDialog(SharedPreferences sharedPreferences) {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String[] whiteArray = sharedPreferences.getString("enableMobileWhiteList", "").split(";");
